...
INSERT INTO `user-center`.`oauth_client_details`(`client_id`, `resource_ids`, `client_secret`, `scope`, `authorized_grant_types`, `web_server_redirect_uri`, `authorities`, `access_token_validity`, `refresh_token_validity`, `additional_information`, `autoapprove`) VALUES ('demo-pc', 'oauth2-resource', '$2a$10$iXm2vvtorkpoGddzdbK9DOL76pPvpB2VlAGyXGskT2dhCW5lH2WVC', 'all', 'password,refresh_token,sms_code', NULL, '', NULL, NULL, NULL, NULL);